...
The Document includes all relevant R code for transparency and reproducibility.

It also reports scale reliability analyses for self-reported measures from an initial intake survey.
